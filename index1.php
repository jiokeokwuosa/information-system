...
?>
<div class="row">
<h2 class="center color" style="font-family: font1;">WAREHOUSE</h2>
    <div class="col-md-4 square clearlink">
                 <a href="pricelist.php?warehouse=1">
    ...
    <div class="col-md-4 square clearlink">
                 <a href="pricelist.php?warehouse=2">
                	<div class="icon center">
            					<i class="glyphicon glyphicon-book" aria-hidden="true"></i>
    ...
    <div class="col-md-4 square clearlink">
                 <a href="pricelist.php?warehouse=3">
                	<div class="icon center">
            					<i class="glyphicon glyphicon-book" aria-hidden="true"></i>
...
<div class="row">
    ...
    <div class="col-md-4 square clearlink">
                 <a href="pricelist.php?warehouse=4">
                	<div class="icon center">
            					<i class="glyphicon glyphicon-book" aria-hidden="true"></i>
    ...
    <div class="col-md-4 square clearlink">
                 <a href="pricelist.php?warehouse=5">
                	<div class="icon center">
            					<i class="glyphicon glyphicon-book" aria-hidden="true"></i>
    ...
    <div class="col-md-4 square clearlink">
                 <a href="pricelist.php?warehouse=6">
                	<div class="icon center">
            					<i class="glyphicon glyphicon-book" aria-hidden="true"></i>
...
<div class="row">
    ...
    <div class="col-md-4 square clearlink">
                 <a href="pricelist.php?warehouse=7">
                	<div class="icon center">
            					<i class="glyphicon glyphicon-book" aria-hidden="true"></i>
    ...
    <div class="col-md-4 square clearlink">
                 <a href="pricelist.php?warehouse=8">
                	<div class="icon center">
            					<i class="glyphicon glyphicon-book" aria-hidden="true"></i>
    ...
    <div class="col-md-4 square clearlink">
                 <a href="pricelist.php?warehouse=9">
                	<div class="icon center">
            					<i class="glyphicon glyphicon-book" aria-hidden="true"></i>
...
<div class="row">
    <div class="col-md-4 square clearlink">
         <a href="pricelist.php?warehouse=10">
                	<div class="icon center">
            					<i class="glyphicon glyphicon-book" aria-hidden="true"></i>
