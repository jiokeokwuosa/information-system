...
if(isset($_POST['month'])){
  ...
  $_SESSION['year']=$_POST['year'];
   ...
   $db->connect();
   $result=$db->select('item_order',array('month'=>$_SESSION['month'],'year'=>$_SESSION['year']));  
   ...
   if($db->numRow()==0){
    echo"<h2 class=center>No data Found</h2>";
     ...
     $status='true'; 
      $result1=$db->select('item_update',array('month'=>$_SESSION['month'],'year'=>$_SESSION['year']));
   }
    ...
    <div class="row" style="font-size: 17px;">
         <div class="col-md-12">
             <table style="width:100%">
                  ...
                  <h3 class="center color">Monthly Report for <?php echo $_SESSION['month'].'-'.$_SESSION['year'];?></h3>
         </div>      
    </div>
