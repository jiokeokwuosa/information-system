...
if(isset($_POST['year'])){
   ...
   $db->connect();
   $result=$db->select('item_order',array('year'=>$_SESSION['year'],'uploader_id'=>$_SESSION['id']));  
   ...
   if($db->numRow()==0){
    echo"<h2 class=center>No data Found</h2>";
     ...
     $status='true'; 
      $result1=$db->select('item_update',array('year'=>$_SESSION['year'],'uploader_id'=>$_SESSION['id']));
   }
...
<div class="container">
    ...
    <div class="row" style="font-size: 17px;">
         <div class="col-md-12">
             <table style="width:100%">
                  ...
                  <h3 class="center color">Annual Report for <?php echo $_SESSION['year'];?>, for Seller Id:<?php echo $_SESSION['id']?></h3>
         </div>      
    </div>
    ...
    <br />
     <h3 class="center color">Quantity Added This Year</h3>
   ...
   <?php
    if(mysqli_num_rows($result1)>0){
       ...
       echo"</ol>"; 
        ...
        echo("<h2>No Quantity was increased this year</h2>");
    }
   ?>  
